...
CREATE TABLE `coupon` (
  ...
  `type01` int DEFAULT NULL,
  `type02` int DEFAULT NULL,
  `type03` int DEFAULT NULL,
  `type04` int DEFAULT NULL,
...
INSERT INTO `coupon` VALUES ('101',1,0,1,0,2),('102',1,1,0,0,2),('103',0,1,1,1,3),('104',1,0,0,0,1),('105',0,1,1,0,2),('106',6,6,6,6,66);
