 ...
 */
@WebServlet("/QueryCouponServlet04")
public class QueryCouponServlet04 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryCouponServlet04() {
        super();
	...
	EntityManagerFactory emf = Persistence.createEntityManagerFactory("myRevitalize1117");
        ...
        request.getRequestDispatcher("coupon04.jsp").forward(request, response);
