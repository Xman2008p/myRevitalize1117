...
/**
 * Servlet implementation class RegisterCouponServlet
 */
@WebServlet("/RegisterCouponServlet")
public class RegisterCouponServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterCouponServlet() {
        super();
